Router.map(function(){
  ...
  this.route('studentDashboardConversation', {path: '/student/conversation', layoutTemplate: 'studentDashboardLayout'});
  ...
  this.route('tabs.one', {path: '/student/standing', layoutTemplate: 'tabsLayout'});
  this.route('tabs.two', {path: '/student/activity', layoutTemplate: 'tabsLayout'});
  this.route('tabs.three', {path: '/student/classroom', layoutTemplate: 'tabsLayout'});
  this.route('tabs.four', {path: '/student/board', layoutTemplate: 'tabsLayout'});
  ...
  this.route('teacherDashboardConversation', {path: '/teacher/conversation', layoutTemplate: 'teacherDashboardLayout'});
