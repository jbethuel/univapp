Router.map(function(){
  ...
  this.route('studentDashboardClassAnnouncement', {path: '/student/announcement', layoutTemplate: 'studentDashboardLayout'});
  this.route('studentDashboardMessenger', {path: '/student/messenger', layoutTemplate: 'studentDashboardLayout'});
  this.route('studentDashboardConversation', {path: '/student/conversation/:teach_id/:class_id',
    data:function(){
      return {teach_id:this.params.teach_id, class_id: this.params.class_id};
  ...
  this.route('studentDashboardClassMessage', {path: '/student/class/message/:class_id',
    data:function(){
      return {class_id:this.params.class_id};
    }, layoutTemplate: 'studentDashboardLayout'});
  this.route('studentViewActivity', {path: '/student/class/activity/view/:activity_id',
    data:function(){
      return {activity_id:this.params.activity_id};
    }, layoutTemplate: 'studentDashboardLayout'});
  ...
  this.route('teacherDashboardConversation', {path: '/teacher/conversation/:stud_id/:class_id',
    data:function(){
      return {teach_id:this.params.stud_id, class_id: this.params.class_id};
  ...
  this.route('teacherStudentList', {path: '/teacher/class/studentlist/:class_id',
    data:function(){
      return {class_id:this.params.class_id};
    }, layoutTemplate: 'teacherDashboardLayout'});
  ...
  this.route('teacherViewActivity', {path: '/teacher/class/activity/view/:activity_id',
    data:function(){
      return {activity_id:this.params.activity_id};
    },layoutTemplate: 'teacherDashboardLayout'});
  this.route('viewfile', {path: '/teacher/class/activity/view/activity/:studentfile_id&:recordId',
    data: function(){
      return {studentfile_id: this.params.studentfile_id,
